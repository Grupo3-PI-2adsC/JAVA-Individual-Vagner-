        ...
        try {
            ...
            if(teste) {
                ...
                con1.query(queryFk, (resultSet) -> {
                    ...
                    Long limiteDisco = con1.queryForObject("""
                    ...
                    if (leiturasDisco > limiteDisco){
                        Slack.sendSlackAlert("Disco", fkMaquina, leiturasDisco);
                    }else if (escritarDisco > limiteDisco){
                        Slack.sendSlackAlert("Disco", fkMaquina, escritarDisco);
                    }
